...
export const DEFAULT_PERMISSIONS = {
  Admin: {
    ...
    invoices: full(), roadmap: full(), projects: full(), logistics: full(),
  ...
  Accounts: {
    ...
    roadmap: none(), projects: read(), logistics: none(),
    agents: none(), calculator: { view: true, create: true, edit: true, delete: false, export: true }, admin: none(),
  },
  Logistics: {
    dashboard: read(), notifications: full(), messages: full(),
    leads: none(), pipeline: none(), customers: read(), partners: none(),
    invoices: none(), roadmap: read(), projects: read(), logistics: ops(),
    agents: none(), calculator: none(), admin: none(),
  },
  Partner: {
    dashboard: full(), notifications: full(), messages: full(),
    leads: none(), pipeline: none(), customers: none(), partners: read(),
    invoices: read(), roadmap: none(), projects: none(), logistics: none(),
    agents: none(), calculator: none(), admin: none(),
  },
  Customer: {
    dashboard: full(), notifications: full(), messages: full(),
    leads: none(), pipeline: none(), customers: none(), partners: none(),
    invoices: read(), roadmap: none(), projects: read(), logistics: read(),
    agents: none(), calculator: none(), admin: none(),
  },
  'Business Client': {
    dashboard: full(), notifications: full(), messages: full(),
